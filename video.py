...
<body>
    <div class='main-card'>
        ...
        <form id="videoForm" onsubmit="sendData(event)">
            ...
            <button type='submit' class='submit-btn'>VYTVOŘIT VIDEO</button>
        </form>
    ...
    <script>
        async function sendData(event) {
            ...
            if (SCRIPT_URL === "https://script.google.com/macros/s/AKfycbwDB8VvtsXjx02XjZ4cw7wBycmZehrDEVmExhTGMKzqpGaHn5qlKgms0DacNu4rJJC7-w/exec") {
                alert("Data byla připravena. Pro automatické ukládání je potřeba vložit SCRIPT_URL.");
                return;
            }
            ...
            try {
                ...
                alert('Data a fotografie byly úspěšně odeslány do systému HVB Video. Hotovo bude do 60 minut.');
            } catch (error) {
...
print(f"✅ Stránka byla vygenerována: {file_name}")
from google.colab import files
