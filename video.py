# -*- coding: utf-8 -*-
"""Video10alfa form 264.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1LRe_5dvShzbj8gyb5xybzQjVuPSTpW2S
...
# Dynamická detekce poměru stran podle první fotky
def detect_aspect_ratio(image_path):
    with Image.open(image_path) as img:
        w, h = img.size
        ratio = w / h
        if ratio > 1.5: # 1.77 je 16:9
            return (1920, 1080), "16:9"
        else: # 1.33 je 4:3
            return (1440, 1080), "4:3"

# Zjistíme rozlišení z prvního dostupného obrázku
first_img = next(iter(image_files)) if 'image_files' in locals() and image_files else None
if first_img:
    (TARGET_W, TARGET_H), DETECTED_RATIO = detect_aspect_ratio(first_img)
    print(f"Detected Aspect Ratio: {DETECTED_RATIO} ({TARGET_W}x{TARGET_H})")
else:
