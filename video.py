...
Original file is located at
    https://colab.research.google.com/drive/1zKebzWsRAFF7QKICJs1ZwmIfLRogLtWc
...
for idx, img_path in enumerate(final_image_paths):
    ...
    clip = clip.crossfadein(0.5)  # Změněno na 0.5s dle požadavku
...
outro_clip = outro_clip.crossfadein(0.5)  # Změněno na 0.5s dle požadavku
